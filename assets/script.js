...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "6/9": titulo = "05 de Maio de 2021"; mensagem = "<p>Esse foi o dia da janta onde conversamos e olhamos a lua num dia nublado kkkkk</p>";break;
            case "9/9": titulo = "08 de Maio de 2021"; mensagem = "<p>Foi o dia que tomei atitude e te chamei pela primeira vez para conversar ❤️</p>";break;
            case "10/9": titulo = "15 de Maio de 2021"; mensagem = "<p>Foi o dia que te passei a minha primeira cantada</p>";break;
            case "18/9": titulo = "22 de Maio de 2021"; mensagem = "<p>Conversamos sobre musica e trocamos musicas romanticas a noite e tarde toda</p>";break;
            case "20/9": titulo = "29 de Maio de 2021"; mensagem = "<p>Voce me chamou de amor pela primeira vez ❤️.</p>";break;
            case "10/10": titulo = "03 de Junho de 2021"; mensagem = "<p>É o dia que foi marcado para conhecer seus pais</p>";break;
            case "17/10": titulo = "03 de Junho de 2021"; mensagem = "<p>Apartir de hoje meu objetivo é te fazer a pessoa mais feliz que existe</p>";break;
